...
class MHST2_IMPORT_PT_TexSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST2_IMPORT_OT_mhst2_tex"
...
class MHST2_IMPORT_PT_TexSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST2_IMPORT_PT_TexSettingPanel_1"
...
class MHST2_ImportTex(bpy.types.Operator, ImportHelper):
    """Import from Tex file format (.tex.*)"""
    bl_idname = "mhst2_import.mhst2_tex"
    bl_label = 'Import MH Stories 2 Tex'
    bl_options = {'UNDO'}
    filename_ext = ".tex"
