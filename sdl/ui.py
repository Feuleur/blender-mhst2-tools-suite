...
class MHST2_IMPORT_PT_SdlSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST2_IMPORT_OT_mhst2_sdl"
...
class MHST2_IMPORT_PT_SdlSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST2_IMPORT_PT_SdlSettingPanel_1"
...
class MHST2_ImportSdl(bpy.types.Operator, ImportHelper):
    """Import from Sdl file format (.sdl)"""
    bl_idname = "mhst2_import.mhst2_sdl"
    bl_label = 'Import MHST2 Sdl'
    bl_options = {'UNDO'}
    filename_ext = ".sdl"
