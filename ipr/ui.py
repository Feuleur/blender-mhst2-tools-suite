...
class MHST2_IMPORT_PT_IprSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST2_IMPORT_OT_mhst2_ipr"
...
class MHST2_IMPORT_PT_IprSettingPanel_2(Panel):
    bl_space_type = 'FILE_BROWSER'
    bl_region_type = 'TOOL_PROPS'
    bl_label = "Texture Settings"
    bl_parent_id = "MHST2_IMPORT_PT_IprSettingPanel_1"
...
class MHST2_ImportIpr(bpy.types.Operator, ImportHelper):
    """Import from Ipr file format (.ipr)"""
    bl_idname = "mhst2_import.mhst2_ipr"
    bl_label = 'Import MHST2 Ipr'
    bl_options = {'UNDO'}
    filename_ext = ".ipr"
