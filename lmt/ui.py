...
class MHST2_IMPORT_PT_LmtSettingPanel_1(Panel):
    ...
    def poll(cls, context):
        ...
        return operator.bl_idname == "MHST2_IMPORT_OT_mhst2_lmt"
...
class MHST2_ImportLmt(bpy.types.Operator, ImportHelper):
    """Import from Lmt file format (.lmt)"""
    bl_idname = "mhst2_import.mhst2_lmt"
    bl_label = 'Import MHST2 Lmt'
    bl_options = {'UNDO'}
    filename_ext = ".lmt"
